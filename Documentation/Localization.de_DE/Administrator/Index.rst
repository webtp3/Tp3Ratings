...
the extention can be installed from the ter tp3ratings
...
* the mapping of microdata is not yet perfect - but help it to be Contribute at https://github.com/webtp3/tp3ratings
